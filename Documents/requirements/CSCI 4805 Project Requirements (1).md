...
10.3.1. Selecting a message from another student's profile will open a private messaging chat with that user.  
10.3.2. If a conversation between two users previously exists, selecting the message will open the previous conversation.  
10.3.3. If no previous conversation exists, selecting a message will allow the user to begin a new conversation.  
10.3.4. The user will not need to provide the other student's phone number or APSU email to begin the private messaging.
